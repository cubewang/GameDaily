...
- (void)viewDidLoad
{
    ...
    [topBarLeftButton setBackgroundImage:[UIImage imageNamed:@"show_articlelist@2x"] forState:UIControlStateNormal];
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad)  {
        ...
        logoutButtonFrame.origin.y = 242;
...
- (void)objectLoader:(RKObjectLoader*)objectLoader didLoadObjects:(NSArray*)objects {
    ...
    if ([objects count] == 0) {
        ...
        [[ZAppDelegate sharedAppDelegate] showInformation:self.view info:@"修改失败"];
        
        return;
    }
    
    [[ZAppDelegate sharedAppDelegate] showInformation:self.view info:@"修改成功"];
