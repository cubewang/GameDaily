...
@interface SettingViewController : UIViewController<UIAlertViewDelegate,RKObjectLoaderDelegate,UIActionSheetDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate> {
